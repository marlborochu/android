...
//		jobs.put(new CheckStorageSize(),"*/10 * * * * *");
		jobs.put(new TaipeiBusJob(),"0 0 */12 * * *");
		jobs.put(new TaichungBusJob(),"0 0 */12 * * *");
		jobs.put(new TainanBusJob(),"0 0 */12 * * *");
		jobs.put(new KaohsiungBusJob(),"0 0 */12 * * *");
		jobs.put(new TWTrainJob(),"0 0 */12 * * *");
		jobs.put(new THSRCTmeTableJob(),"0 0 */12 * * *");
	}
